...
#DEFAULT_IMAGE_DIR = "." + sep + "acoustic_guitar"
#DEFAULT_IMAGE_DIR = "." + sep + "backpack"
#DEFAULT_IMAGE_DIR = "." + sep + "baseball"
#DEFAULT_IMAGE_DIR = "." + sep + "chair"
#DEFAULT_IMAGE_DIR = "." + sep + "electric_guitar"
#DEFAULT_IMAGE_DIR = "." + sep + "guac"
DEFAULT_IMAGE_DIR = "." + sep + "keyboard"
#DEFAULT_IMAGE_DIR = "." + sep + "mouse"
#DEFAULT_IMAGE_DIR = "." + sep + "mug"
#DEFAULT_IMAGE_DIR = "." + sep + "screwdriver"
...
threads_per_dev = 1 # for each4device one executable network will be created and this many threads will be

simultaneous_infer_per_thread = 2  # Each thread will start this many async inferences at at time.
...
def main():
    ...
    if (time_threads):
        ...
        print("--- Total FPS: " + '{0:.4f}'.format(total_thread_fps))
        print("--- FPS per device: " + '{0:.4f}'.format(total_thread_fps / num_ncs_devs))
        print("---------------------------------------------------------")
